...
public class RequirementsAnalysis {
	...
	public void EntertainmentRequirement(){
		...
		requirement_list.addRequirement(new Requirement("1.2.3","下载一些好看的电影",false));
	}
	...
	public  void DocumentRequirement(){
		requirement_list.addRequirement(new Requirement("1.5","写论文和专利",false));
		requirement_list.addRequirement(new Requirement("1.5.1","下载相关文献",false));
	}
	...
	public  void SoftwareDevelopmentRequirement(){
		...
		requirement_list.addRequirement(new Requirement("2.1.1.5","软件界面较为友好",false));
		requirement_list.addRequirement(new Requirement("2.1.1.5.1","action bar颜色",false));
		requirement_list.addRequirement(new Requirement("2.1.1.5.1","修改搜索按钮图标",false));
		requirement_list.addRequirement(new Requirement("2.1.1.6","避免侵权行为",false));
	}
