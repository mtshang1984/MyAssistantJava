...
public class AssistantLife {
	public static void runToday() {
		...
		/*
		 search_engine.BrowseSearchResults(SearchEngineEnum.download, "webstrom 10.0.4");

		 search_engine.BrowseSearchResults(SearchEngineEnum.web, "win10 锁定 任务栏 两个 图标");

		 search_engine.BrowseSearchResults(SearchEngineEnum.download, "goodsync 9.9");

		 search_engine.BrowseSearchResults(SearchEngineEnum.download, "GoodSync");
		 search_engine.BrowseSearchResults(SearchEngineEnum.web, "厨房 筒灯 瓦数");
		 search_engine.BrowseSearchResults(SearchEngineEnum.download, "港囧(蓝光原盘)(1080p)");
		 search_engine.BrowseSearchResults(SearchEngineEnum.download, "港囧 1080p");
		 search_engine.BrowseSearchResults(SearchEngineEnum.download, "mkv 2015");
		 search_engine.BrowseSearchResults(SearchEngineEnum.download, "ansys 15");
		 search_engine.BrowseSearchResults(SearchEngineEnum.luntan, "门 锁 合页");
		 search_engine.BrowseSearchResults(SearchEngineEnum.shopping, "罗格朗 六类");
		 search_engine.BrowseSearchResults(SearchEngineEnum.shopping, "安普 六类 模块");
		 search_engine.BrowseSearchResults(SearchEngineEnum.shopping, "史密斯 小厨宝");
		 search_engine.BrowseSearchResults(SearchEngineEnum.shopping, "奥普 6020");
		 search_engine.BrowseSearchResults(SearchEngineEnum.luntan, "奥普 1020");
		 search_engine.BrowseSearchResults(SearchEngineEnum.shopping, "AO史密斯 小厨宝");
		 search_engine.BrowseSearchResults(SearchEngineEnum.shopping, "林内 13L");
		 search_engine.BrowseSearchResults(SearchEngineEnum.download, "煎饼侠");
		 search_engine.BrowseSearchResults(SearchEngineEnum.wenda, "pc 直播");
		 search_engine.BrowseSearchResults(SearchEngineEnum.web, "手机 选购");
		 */       
	...
	public static void runOldDay() {
		...
		/*
		 ...
		 search_engine.BrowseSearchResults(SearchEngineEnum.download, "MindManager");
		 search_engine.BrowseSearchResults(SearchEngineEnum.web, "Mindjet maps dropbox 同步");
		 search_engine.BrowseSearchResults(SearchEngineEnum.web, "shadow socks gae 结合");
		 search_engine.BrowseSearchResults(SearchEngineEnum.web, "polymer 例子");
		 search_engine.BrowseSearchResults(SearchEngineEnum.download, "office 2013");
		 search_engine.BrowseSearchResults(SearchEngineEnum.download, "Illustrator");
		 search_engine.BrowseSearchResults(SearchEngineEnum.download, "allway sync 15");
		 ...
		 search_engine.BrowseSearchResults("download", "cn windows 10 enterprise x64 ");
		 search_engine.BrowseSearchResults("download", "cn_windows_10_enterprise_x64_dvd_6846957");
		 ...
		 * 
		 ...
		 search_engine.BrowseSearchResults("download", "enterprise architect 12 crack");
